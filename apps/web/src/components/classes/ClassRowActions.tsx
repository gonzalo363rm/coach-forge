...
type Props = {
    id: string
    title: string
    deleteClass: (id: string) => Promise<DeleteResult>
}

export function ClassRowActions({ id, title, deleteClass }: Props) {
    const titleId = useId()
    ...
    return (
        <div className="gap-1">
            <div className="flex items-center gap-2">
                <ButtonLink href={`/classes/${id}/start`} variant="primary" size="sm">
                    Comenzar
                </ButtonLink>
                <ButtonLink href={`/classes/${id}/edit`} variant="secondary" size="sm">
                    Editar
                </ButtonLink>
                <Button
                    type="button"
